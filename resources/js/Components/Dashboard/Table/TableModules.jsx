            ...
            render: (e, data) => {
                return (
                    <div className="flex flex-col">
                        <Link
                            href={route("permissions.index", data.id)}
                            className="btn btn-sm btn-info hover:text-yellow-400 my-3"
                        >
                            Permission
                        </Link>
                        <Link
                            href={route("modules.edit", data.id)}
                        ...
                        <button
                            onClick={() => {
                                if (
                                    confirm(
                                        "Are you sure you want to delete this modul?"
                                    )
                                ) {
                                    router.delete(
                                        route("modules.destroy", data.id)
                                    );
                                }
                            }}
